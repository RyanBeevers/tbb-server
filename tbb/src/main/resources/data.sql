...
INSERT INTO INVOICES (INVOICE_ID, INVOICE_DATE_OF_ISSUE, INVOICE_DISCOUNT, INVOICE_PAID_DATE, INVOICE_PAID_FLAG, INVOICE_PAY_BY_DATE, INVOICE_TOTAL, USER_ID) VALUES
(1, '06/01/2019', 0, '06/01/2019', 1,'06/01/2019', 100.00, 1001);
INSERT INTO INVOICES (INVOICE_ID, INVOICE_DATE_OF_ISSUE, INVOICE_DISCOUNT, INVOICE_PAID_DATE, INVOICE_PAID_FLAG, INVOICE_PAY_BY_DATE, INVOICE_TOTAL, USER_ID) VALUES
(2, '06/01/2019', 20, null, 0, '06/01/2019', 20.00, 1002);
INSERT INTO INVOICES (INVOICE_ID, INVOICE_DATE_OF_ISSUE, INVOICE_DISCOUNT, INVOICE_PAID_DATE, INVOICE_PAID_FLAG, INVOICE_PAY_BY_DATE, INVOICE_TOTAL, USER_ID) VALUES
(3, '06/01/2019', 40, '06/01/2019', 1, '06/01/2019', 160.00, 1003);
INSERT INTO INVOICES (INVOICE_ID, INVOICE_DATE_OF_ISSUE, INVOICE_DISCOUNT, INVOICE_PAID_DATE, INVOICE_PAID_FLAG, INVOICE_PAY_BY_DATE, INVOICE_TOTAL, USER_ID) VALUES
(4, '06/01/2019', 20, null, 0, '06/01/2019' , 140.00, 1004);
INSERT INTO INVOICES (INVOICE_ID, INVOICE_DATE_OF_ISSUE, INVOICE_DISCOUNT, INVOICE_PAID_DATE, INVOICE_PAID_FLAG, INVOICE_PAY_BY_DATE, INVOICE_TOTAL, USER_ID) VALUES
(5, '06/01/2019', 0, '06/01/2019', 1, '06/01/2019', 1000.00, 1001);
...
TASK_NAME, TASK_STATUS, TASK_SUBMITTED_DATE, INVOICE_ID, USER_ID) VALUES
...
INSERT INTO TASKS (TASK_ID, TASK_ACTUAL_EFFORT, TASK_COST_PER_HOUR, TASK_DESC, TASK_DUE_DATE, TASK_ESTIMATED_COST, TASK_ESTIMATED_EFFORT, TASK_FINAL_COST,
TASK_NAME, TASK_STATUS, TASK_SUBMITTED_DATE, INVOICE_ID, USER_ID) VALUES(6, 4, 14.20, 'This is 5 task.', current_timestamp, 100.00, 8, 81.60, 'do a thing', 'Completed', current_timestamp, 4, 1004);
INSERT INTO TASKS (TASK_ID, TASK_ACTUAL_EFFORT, TASK_COST_PER_HOUR, TASK_DESC, TASK_DUE_DATE, TASK_ESTIMATED_COST, TASK_ESTIMATED_EFFORT, TASK_FINAL_COST,
TASK_NAME, TASK_STATUS, TASK_SUBMITTED_DATE, INVOICE_ID, USER_ID) VALUES
(7, 5, 15.20, 'This is 6 task.', current_timestamp, 100.00, 8, 81.60, 'do a thing', 'Completed', current_timestamp, 5, 1004);

INSERT INTO CHALLENGE_QUESTIONS (CHALLENGE_QUESTION_ID, USER_ID, CHALLENGE_QUESTION, CHALLENGE_ANSWER) VALUES
(1001, 1004, 'What is your mothers maiden name?', 'Femling');
INSERT INTO CHALLENGE_QUESTIONS (CHALLENGE_QUESTION_ID, USER_ID, CHALLENGE_QUESTION, CHALLENGE_ANSWER) VALUES
(1002, 1004, 'What is your fathers middle name?', 'Vincent');

INSERT INTO CHALLENGE_QUESTIONS (CHALLENGE_QUESTION_ID, USER_ID, CHALLENGE_QUESTION, CHALLENGE_ANSWER) VALUES
(1003, 1001, 'What is your mothers maiden name?', 'Femling');
INSERT INTO CHALLENGE_QUESTIONS (CHALLENGE_QUESTION_ID, USER_ID, CHALLENGE_QUESTION, CHALLENGE_ANSWER) VALUES
(1004, 1001, 'What is your fathers middle name?', 'Vincent');

INSERT INTO CHALLENGE_QUESTIONS (CHALLENGE_QUESTION_ID, USER_ID, CHALLENGE_QUESTION, CHALLENGE_ANSWER) VALUES
(1005, 1002, 'What is your mothers maiden name?', 'Femling');
INSERT INTO CHALLENGE_QUESTIONS (CHALLENGE_QUESTION_ID, USER_ID, CHALLENGE_QUESTION, CHALLENGE_ANSWER) VALUES
(1006, 1002, 'What is your fathers middle name?', 'Vincent');

INSERT INTO CHALLENGE_QUESTIONS (CHALLENGE_QUESTION_ID, USER_ID, CHALLENGE_QUESTION, CHALLENGE_ANSWER) VALUES
(1007, 1003, 'What is your mothers maiden name?', 'Femling');
INSERT INTO CHALLENGE_QUESTIONS (CHALLENGE_QUESTION_ID, USER_ID, CHALLENGE_QUESTION, CHALLENGE_ANSWER) VALUES
(1008, 1003, 'What is your fathers middle name?', 'Vincent');

INSERT INTO SERVICES (SERVICE_ID, CARD_TITLE, CARD_IMG, CARD_TITLE_2, CARD_DESC, CARD_PRICING_DETAIL) VALUES
(1001, 'Event Planning', 'https://images.pexels.com/photos/267507/pexels-photo-267507.jpeg?cs=srgb&dl=businessmen-classroom-communication-267507.jpg&fm=jpg',
...
INSERT INTO SERVICES (SERVICE_ID, CARD_TITLE, CARD_IMG, CARD_TITLE_2, CARD_DESC, CARD_PRICING_DETAIL) VALUES(
1002, 'Travel Management', 'https://images.pexels.com/photos/1204649/pexels-photo-1204649.jpeg?cs=srgb&dl=brainstorming-collaborate-collaboration-1204649.jpg&fm=jpg',
...
INSERT INTO SERVICES (SERVICE_ID, CARD_TITLE, CARD_IMG, CARD_TITLE_2, CARD_DESC, CARD_PRICING_DETAIL) VALUES(
1003, 'Administrative Assistant', 'http://www.intheblack.com/~/media/intheblack/allimages/sponsored-content/2018/dexus-office-space.jpg',
...
INSERT INTO SERVICES (SERVICE_ID, CARD_TITLE, CARD_IMG, CARD_TITLE_2, CARD_DESC, CARD_PRICING_DETAIL) VALUES(
1004, 'Virtual Assistant','https://img-prod-cms-rt-microsoft-com.akamaized.net/cms/api/am/imageFileData/RE28gcp?ver=be70&q=90&m=2&h=768&w=1024&b=%23FFFFFFFF&aim=true',
